...
func TestType_UnmarshalJSON(t *testing.T) {
	...
	tests := []struct{
		Datum []byte
		ExpectedValue cel_name.Type
		ExpectedErr error
	}{
		{
			Datum: []byte(nil),
			ExpectedValue: cel_name.Nothing(),
		...
		{
			Datum:                    []byte(`"apple"`),
			ExpectedValue: cel_name.Something("apple"),
			ExpectedErr: nil,
		},
		{
			Datum:                    []byte(`"banana"`),
			ExpectedValue: cel_name.Something("banana"),
			ExpectedErr: nil,
		},
		{
			Datum:                    []byte(`"cherry"`),
			ExpectedValue: cel_name.Something("cherry"),
			ExpectedErr: nil,
		},
